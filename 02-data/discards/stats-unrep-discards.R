...
stats_y<-function(variable){
  ...
  return(cbind(c(2001:2023),q5, q50,q95))
}
...
stats_y_k<-function(variable){
  ...
  l1<-cbind(c(2001:2023),q5[,1], q50[,1],q95[,1])
  l2<-cbind(c(2001:2023),q5[,2], q50[,2],q95[,2])
  colnames(l1)<-colnames(l2)<-c("year", "q5", "q50", "q95")
  return(list(l1, l2))
}
