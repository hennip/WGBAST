...
#run1 <- extend.jags(run0, combine=F, sample=1000, thin=1, keep.jags.files=T,method = 'parallel')
...
t1<-Sys.time();print(t1)
run1 <- extend.jags(run0, combine=F, sample=1000, thin=100, keep.jags.files=T,method = 'parallel')      #adapt=0
t2<-Sys.time();print(t2)
print("run1 done"); print(difftime(t2,t1))
print("--------------------------------------------------")
run<-run1
...
#
#t1<-Sys.time();print(t1)
# run1 <- extend.jags(run0, combine=F, sample=400, thin=100, keep.jags.files=T)
# t2<-Sys.time();print(t2)
# print("run1 done"); print(difftime(t2,t1))
#print("--------------------------------------------------")
# run<-run1
...
#
# t3<-Sys.time();print(t3)
# run2 <- extend.jags(run1, combine=T, sample=400, thin=100, keep.jags.files=T)
# t4<-Sys.time();print(t4)
# print("run2 done");print(difftime(t4,t3))
#print("--------------------------------------------------")
# run<-run2
...
#
# t5<-Sys.time();print(t5)
# run3 <- extend.jags(run2, combine=T, sample=400, thin=100, keep.jags.files=T)
# t6<-Sys.time();print(t6)
# print("run3 done");print(difftime(t6,t5))
#print("--------------------------------------------------")
#
...
#
# t7<-Sys.time();print(t7)
# run4 <- extend.jags(run3, combine=T, sample=400, thin=100, keep.jags.files=T)
# t8<-Sys.time();print(t8)
# print("run4 done");print(difftime(t8,t7))
#print("--------------------------------------------------")
#
...
#
# t9<-Sys.time();print(t9)
# run5 <- extend.jags(run4, combine=T, sample=400, thin=100, keep.jags.files=T)
# t10<-Sys.time();print(t10)
# print("run5 done");print(difftime(t9,t10))
#print("--------------------------------------------------")
#
...
#
# t11<-Sys.time();print(t11)
# run6 <- extend.jags(run5, combine=T, sample=400, thin=100, keep.jags.files=T)
# t12<-Sys.time();print(t12)
# print("run6 done");print(difftime(t11,t12))
#print("--------------------------------------------------")
#
