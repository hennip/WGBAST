...
mu_mps<- -2.0360 # median survival 2019-2022 13%, -1.849 (16%)
w_mps<-0.94
sigma2_mps<-0.52
...
rivHRall<-as.matrix(read.table(paste0(PathData,"rivHR.txt"),header=T,row.names=1))
colnames(rivHRall)<-NULL      
rownames(rivHRall)<-NULL 

rivHR<-rivHRall[6:dim(rivHRall)[1], ]  #1992 ->

source(paste0(PathFiles,"Inputs_loops_2024_Nimble.r"))
