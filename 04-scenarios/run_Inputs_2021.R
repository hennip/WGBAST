...
Model<-"test" # data until 2019; test struct for LW, AR struct for HRtr, qll, qdn
...
if(Model=="test"){load(file="C:/output/wgbast/flhm/FLHM_2020XY2_test_data2020.RData")}; chains<-as.mcmc.list(run)
...
source(paste0(PathFiles,"Inputs_loops_tr.r"))
