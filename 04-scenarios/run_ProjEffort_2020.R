...
CoefTrollingF<-1.245#0.737 # # this coef produces the targetTr of recr catch when commercial fisheries are removed 
...
if(EffScen==1){Coef2<-2.582; target<-142.7} # previous advice approach
