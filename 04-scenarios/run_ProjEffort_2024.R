...
# Paths are specified in a separate file 
 ...
 # Becky:
 # ===============
    PathSim<-"//storage-dh.slu.se/home$/rewh0001/My Documents/ICES WGBAST/2024/"   # results from the simulation model and output from scenarios
    PathData<-"C:/WGBAST15/WGBAST_2024/data_2024/" # extra input files 
    PathScen<-"C:/WGBAST15/2024_scenarios/" # scenario results 
    PathFiles<-"//storage-dh.slu.se/home$/rewh0001/My Documents/ICES WGBAST/2024/Scenarios/"
...
# calendar year 2025 is year 34 for trapnetting and 
# year 33 for offshore fisheries (updated 28/03/2024)
yCTN<-34 
yOLL<-33
...
if(SD31only==F){
E_CTN_FIN_30<-c(rep(3.70,2)) # thousand trapdays updated Mar 24
E_CTN_SWE_30<-c(rep(1.27,2))  
}else{
E_CTN_FIN_30<-c(3.70,0) # thousand trapdays   #scens 12-15 run as 5-7,9 above
E_CTN_SWE_30<-c(1.27,0)             
}

E_CTN_FIN_31<-c(rep(5.927,2))     #updated Mar 24 
E_CTN_SWE_31<-c(rep(7.205,2)) 


# Load SR errors
load(paste0(PathFiles, "SR_devs_2024.RData"))

# =============================================================

# Initialise arrays
source(paste0(PathFiles,"InitArrays_2024.r")) # time varying Htr, ql, qd
...
source(paste0(PathFiles,"ProjEffort_loops_2024.r")) # time varying Htr, ql, qd
