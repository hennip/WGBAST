...
#  }else{
     CoefTRW<-ifelse(EffScen %in% c(1,2,6:12),0,0.164740551136661)  #updated 10/04  21
     CoefTRR<-ifelse(EffScen %in% c(1,2,6:12),0,1.30172682275351)   # 22
#  }
...
#    ROLL_HR[3:6,y,,]<- 1-exp(-ql_R[2,y,]* EffortAU[y,1,"OLL",])
 ...
 #   print(MatW_2[,,1,1])
    ...
    for(a in 1:6){
      for(r in 1:Nstocks){
        # Set river catch zero for Ljungan, Em̴n, Testebo̴n & K̴ge
