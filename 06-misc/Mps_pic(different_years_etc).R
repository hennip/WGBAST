#########################################################
#   plotting different mps plots with selected years    #
#########################################################
...
#for(i in 1:2){}
gg1 <- ggplot(df2 %>% filter(Year<2022), aes(Year, group=Year))+
...
png(filename = "06-misc/MPSwo2023_2021.png", res = 300, 
